...
for i in range(len(output_dseq_E_List)):
	output_dseq_E_List[i] = int(output_dseq_E_List[i])
...
for i in range(len(output_dseq_V_List)):
	output_dseq_V_List[i] = int(output_dseq_V_List[i])
...
for i in range(len(input_dseq_E_List)):
	input_dseq_E_List[i] = int(input_dseq_E_List[i])
...
for i in range(len(input_dseq_V_List)):
	input_dseq_V_List[i] = int(input_dseq_V_List[i])
...
plt.plot(input_E_x, input_E_y, marker = 'o', linestyle = '--', color='g', label='Input E Degree')
