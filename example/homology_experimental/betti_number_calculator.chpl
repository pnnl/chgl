/*Calculation of betti numbers for k = 1 and k =2 */
/*To compile: chpl -o betti_number_calculator --fast --cc-warnings -M../../src --dynamic --no-lifetime-checking --no-warnings betti_number_calculator.chpl */
