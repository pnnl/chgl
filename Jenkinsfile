    ...
    stages {
        ...
        stage('Performance Test') {
            steps {
                ...
                sh 'sed -i \\"s|</head>|<meta http-equiv=\\x22Content-Security-Policy\\x22 content=\\x22default-src \\*; style-src \\x27self\\x27 \\x27unsafe-inline\\x27; script-src \\x27self\\x27 \\x27unsafe-inline\\x27 \\x27unsafe-eval\\x27 https://cdnjs.cloudflare.com/ \\x22></head>|\\" ${WORKSPACE}/test/performance/dat/html/index.html'
            }
            post {
                always { 
